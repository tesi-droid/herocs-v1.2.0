 ...
 * Versione 1.2.0 - Copertura completa media, opzioni visibilità contenuti
 *
 * @package HeroCS
 * @since 1.2.0
 */
...
if ($enable_slider && is_front_page()) {
    ...
    include(get_template_directory() . '/template-parts/hero-slider.php');
    ...
    $title = get_theme_mod('cs_hero_title', 'HeroCS');
