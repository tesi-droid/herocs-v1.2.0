                ...
                <div class="post-layout <?php echo get_theme_mod('cs_sidebar_position', 'right') !== 'none' ? 'has-sidebar sidebar-' . get_theme_mod('cs_sidebar_position', 'right') : 'no-sidebar'; ?>">
                    ...
                    <div class="post-content-wrapper">
                        ...
                        <header class="entry-header">
                            ...
                            <div class="entry-meta">
                                ...
                                <span class="meta-views">
                                    ...
                                    <?php echo esc_html(cs_get_post_views()); ?> <?php esc_html_e('views', 'cs-communication'); ?>
                                </span>
                            </div>
                        </header>
                        ...
                        <div class="entry-content cs-content-wrapper">
                            ...
                            the_content(sprintf(
                                wp_kses(
                                    __('Continue reading<span class="screen-reader-text"> "%s"</span>', 'cs-communication'),
                        ...
                        <footer class="entry-footer">
                            <?php
                            // Tags
                            $tags_list = get_the_tag_list('', esc_html_x(', ', 'list item separator', 'cs-communication'));
                            if ($tags_list) :
                                ?>
                                <div class="post-tags">
                                    <span class="tags-label">
                                        ...
                                        <?php esc_html_e('Tags:', 'cs-communication'); ?>
                                    </span>
                                    <?php echo $tags_list; ?>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="post-share">
                                <span class="share-label"><?php esc_html_e('Share:', 'cs-communication'); ?></span>
                                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()); ?>" 
                                   target="_blank" 
                                   rel="noopener noreferrer"
                                   class="share-btn share-facebook"
                                   aria-label="<?php esc_attr_e('Share on Facebook', 'cs-communication'); ?>">
                                ...
                                <a href="https://twitter.com/intent/tweet?url=<?php echo urlencode(get_permalink()); ?>&text=<?php echo urlencode(get_the_title()); ?>" 
                                   ...
                                   aria-label="<?php esc_attr_e('Share on Twitter', 'cs-communication'); ?>">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo urlencode(get_permalink()); ?>&title=<?php echo urlencode(get_the_title()); ?>" 
                                   ...
                                   aria-label="<?php esc_attr_e('Share on LinkedIn', 'cs-communication'); ?>">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <div class="author-bio cs-reveal">
                                ...
                                <div class="author-info">
                                    ...
                                    <a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>" class="author-posts-link">
                                        <?php esc_html_e('View all posts', 'cs-communication'); ?> ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢
                                    </a>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <!-- Post Navigation -->
                        <nav class="post-navigation" aria-label="<?php esc_attr_e('Post navigation', 'cs-communication'); ?>">
                            <div class="nav-links">
                                <?php
                                ...
                                if ($prev_post) :
                                    ...
                                    <div class="nav-previous">
                                        <a href="<?php echo esc_url(get_permalink($prev_post)); ?>" rel="prev">
                                            <span class="nav-subtitle">ÃƒÂ¢Ã¢â‚¬Â Ã‚Â <?php esc_html_e('Previous', 'cs-communication'); ?></span>
                                ...
                                <?php if ($next_post) : ?>
                                    <div class="nav-next">
                                        <a href="<?php echo esc_url(get_permalink($next_post)); ?>" rel="next">
                                            <span class="nav-subtitle"><?php esc_html_e('Next', 'cs-communication'); ?> ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢</span>
