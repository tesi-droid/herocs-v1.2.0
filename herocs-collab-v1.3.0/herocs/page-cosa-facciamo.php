...
$servizi_default = array(
    ...
    array(
        ...
        'description' => 'Supporto alle istituzioni pubbliche per una comunicazione efficace e trasparente con i cittàdini.',
        'link' => '#',
    ),
    array(
    ...
    array(
        ...
        'description' => 'Presenza digitale strategica su tutti i canali online per massimizzare la visibilità del tuo brand.',
        'link' => '#',
    ),
    array(
        'icon' => 'video',
        'title' => 'Produzione Contenuti',
        'description' => 'Creazione di contenuti multimediali di alta qualità: video, fotografia, grafiche e copywriting.',
        'link' => '#',
    ),
    array(
        'icon' => 'bar-chart',
                ...
                <?php if (current_user_can('edit_posts')) : ?>
                    <div class="admin-notice">
                        <p>
                            ...
                            <a href="<?php echo admin_url('post-new.php?post_type=service'); ?>">Aggiungi il primo servizio â" '</a>
                        </p>
                    </div>
                <?php endif; ?>
            <?php endif; ?>
        ...
        <div class="metodo-container">
            ...
            <div class="metodo-grid">
                ...
                <div class="metodo-step">
                    ...
                    <div class="step-content">
                        <h3>Creazione</h3>
                        <p>Realizziamo contenuti e campagne di alta qualità per ogni canale.</p>
                    </div>
                </div>
