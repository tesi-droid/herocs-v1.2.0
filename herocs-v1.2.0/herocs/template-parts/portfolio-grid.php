...
<article id="post-<?php the_ID(); ?>" <?php post_class('portfolio-item cs-stagger-item ' . $category_class); ?>>
    <a href="<?php the_permalink(); ?>" class="portfolio-link" aria-label="<?php echo esc_attr(sprintf(__('View %s', 'cs-communication'), get_the_title())); ?>">
        ...
        <?php else : ?>
            <div class="portfolio-thumbnail placeholder">
                <span class="placeholder-text"><?php esc_html_e('No Image', 'cs-communication'); ?></span>
            </div>
        <?php endif; ?>
        ...
        <div class="portfolio-content">
            ...
            <span class="portfolio-link-text">
                <?php esc_html_e('View Project', 'cs-communication'); ?> ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢
            </span>
        </div>
    </a>
</article>