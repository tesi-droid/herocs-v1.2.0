...
<div class="collaborazioni-grid cs-stagger-group">
    <?php while ($collab_query->have_posts()) : $collab_query->the_post(); ?>
        ...
        $tipologie = get_the_terms(get_the_ID(), 'tipologià_cliente');
                ...
                <div class="collaborazione-content">
                    ...
                    <?php if ($tipologie && !is_wp_error($tipologie)) : ?>
                        <div class="collaborazione-tipologie">
                            <?php foreach ($tipologie as $tipologià) : ?>
                                <span class="tipologià-badge"><?php echo esc_html($tipologià->name); ?></span>
                            <?php endforeach; ?>
                        </div>
                    <?php endif; ?>
                        ...
                        <?php if ($website) : ?>
                            <a href="<?php echo esc_url($website); ?>" 
                               ...
                               rel="noopener noreferrer">
                                ...
                                <?php esc_html_e('Sito web', 'herocs'); ?>
                            </a>
                        <?php endif; ?>
                        
                        <a href="<?php the_permalink(); ?>" class="read-more-link">
                            <?php esc_html_e('Scopri di più', 'herocs'); ?> →
                        </a>
                    </div>
                </div>
            </div>
