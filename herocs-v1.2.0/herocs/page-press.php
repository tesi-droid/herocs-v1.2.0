        ...
        <?php endwhile; ?>
                ...
                <section class="press-section">
                    <div class="section-header cs-reveal">
                        <h2><?php esc_html_e('Ultimi Articoli', 'cs-communication'); ?></h2>
                    </div>
                                            ...
                                            <div class="press-actions">
                                                <?php if ($link) : ?>
                                                    <a href="<?php echo esc_url($link); ?>" class="cs-link cs-link-arrow" target="_blank" rel="noopener noreferrer">
                                                        <?php esc_html_e('Leggi online', 'cs-communication'); ?>
                                                        <svg class="icon icon-sm" aria-hidden="true">
                                                ...
                                                <?php if ($pdf) : ?>
                                                    <a href="<?php echo esc_url($pdf); ?>" class="cs-link cs-link-arrow" target="_blank" rel="noopener noreferrer" download>
                                                        <?php esc_html_e('Scarica PDF', 'cs-communication'); ?>
                                                        <svg class="icon icon-sm" aria-hidden="true">
                    ...
                    <?php else : ?>
                        <div class="empty-state cs-reveal">
                            <p><?php esc_html_e('Nessun articolo press trovato.', 'cs-communication'); ?></p>
                        </div>
                    <?php endif; ?>
                ...
                <section class="featured-press-section cs-reveal">
                    <div class="section-header text-center">
                        <h2><?php esc_html_e('In Evidenza', 'cs-communication'); ?></h2>
                        <p class="section-subtitle"><?php esc_html_e('Le nostre ultime pubblicazioni', 'cs-communication'); ?></p>
                    </div>
                            ...
                            <?php while ($featured_query->have_posts()) : $featured_query->the_post(); ?>
                                ...
                                <article class="featured-item cs-stagger-item">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <?php if ($link) : ?>
                                            <a href="<?php echo esc_url($link); ?>" class="cs-link cs-link-arrow" target="_blank" rel="noopener noreferrer">
                                                <?php esc_html_e('Leggi l\'articolo', 'cs-communication'); ?>
                                                <svg class="icon icon-sm" aria-hidden="true">
                                                    <use href="#icon-arrow-right"></use>
                                                </svg>
                                            </a>
                ...
                <section class="press-stats cs-reveal">
                    <h2 class="text-center"><?php esc_html_e('La Nostra Presenza Media', 'cs-communication'); ?></h2>
                    ...
                    <div class="stats-grid">
                        ...
                        <div class="stat-card">
                            <div class="stat-icon">ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â°</div>
                            <div class="stat-value cs-counter" data-target="<?php echo esc_attr($total_press); ?>">0</div>
                            <p class="stat-label"><?php esc_html_e('Pubblicazioni Totali', 'cs-communication'); ?></p>
                        </div>
                        
                        <div class="stat-card">
                            <div class="stat-icon">ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Â¦</div>
                            <div class="stat-value cs-counter" data-target="<?php echo esc_attr($year_count); ?>">0</div>
                            <p class="stat-label"><?php printf(esc_html__('Nel %s', 'cs-communication'), date('Y')); ?></p>
                        </div>
                        
                        <div class="stat-card">
                            <div class="stat-icon">ÃƒÂ°Ã…Â¸Ã…Â½Ã‚Â¯</div>
                            <div class="stat-value">50+</div>
                            <p class="stat-label"><?php esc_html_e('Testate Nazionali', 'cs-communication'); ?></p>
                        </div>
                    </div>
                </section>
                ...
                <section class="press-cta-section cs-reveal">
                    <div class="cta-box">
                        <div class="cta-content">
                            <h2><?php esc_html_e('Ufficio Stampa', 'cs-communication'); ?></h2>
                            <p><?php esc_html_e('Per richieste media, interviste o informazioni sui nostri progetti, contattaci', 'cs-communication'); ?></p>
                        </div>
                        <div class="cta-buttons">
                            <a href="mailto:press@cscommunication.it" class="cs-btn cs-btn-primary">
                                <svg class="icon icon-sm" aria-hidden="true">
                                    <use href="#icon-mail"></use>
                                </svg>
                                <?php esc_html_e('Email Ufficio Stampa', 'cs-communication'); ?>
                            </a>
                            <a href="<?php echo esc_url(home_url('/contatti')); ?>" class="cs-btn cs-btn-secondary">
                                <?php esc_html_e('Vai ai Contatti', 'cs-communication'); ?>
                            </a>
                        </div>
                    </div>
                </section>
