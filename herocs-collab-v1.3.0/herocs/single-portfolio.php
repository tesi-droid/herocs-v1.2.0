            ...
            <div class="portfolio-header cs-container">
                <div class="portfolio-header-content">
                    ...
                    <div class="portfolio-meta">
                        <?php if ($client) : ?>
                            <div class="meta-item">
                                <span class="meta-label"><?php esc_html_e('Client', 'herocs'); ?></span>
                        ...
                        <?php if ($project_date) : ?>
                            <div class="meta-item">
                                <span class="meta-label"><?php esc_html_e('Date', 'herocs'); ?></span>
                        ...
                        <?php if ($role) : ?>
                            <div class="meta-item">
                                <span class="meta-label"><?php esc_html_e('Our Role', 'herocs'); ?></span>
                        ...
                        <?php if ($project_url) : ?>
                            <div class="meta-item">
                                <span class="meta-label"><?php esc_html_e('Website', 'herocs'); ?></span>
                                <span class="meta-value">
                                    <a href="<?php echo esc_url($project_url); ?>" target="_blank" rel="noopener noreferrer">
                                        <?php esc_html_e('Visit Project', 'herocs'); ?> →
                                    </a>
                                </span>
                            </div>
                        <?php endif; ?>
            ...
            <div class="portfolio-content cs-container cs-content-wrapper">
                ...
                <?php if ($results) : ?>
                    <div class="portfolio-results cs-reveal">
                        <h2><?php esc_html_e('Results & Achievements', 'herocs'); ?></h2>
                ...
                if ($tags && !is_wp_error($tags)) :
                    ...
                    <div class="portfolio-tags">
                        <span class="tags-label"><?php esc_html_e('Tags:', 'herocs'); ?></span>
                ...
                <div class="nav-links">
                    ...
                    if ($prev_post) :
                        ...
                        <div class="nav-previous">
                            <a href="<?php echo esc_url(get_permalink($prev_post)); ?>" rel="prev">
                                <span class="nav-subtitle"><?php esc_html_e('Previous Project', 'herocs'); ?></span>
                    ...
                    <div class="nav-center">
                        <a href="<?php echo esc_url(get_post_type_archive_link('portfolio')); ?>" class="back-to-portfolio">
                            <?php esc_html_e('All Projects', 'herocs'); ?>
                        </a>
                    </div>
                    ...
                    <?php if ($next_post) : ?>
                        <div class="nav-next">
                            <a href="<?php echo esc_url(get_permalink($next_post)); ?>" rel="next">
                                <span class="nav-subtitle"><?php esc_html_e('Next Project', 'herocs'); ?></span>
                    ...
                    <section class="related-projects">
                        <div class="cs-container">
                            <h2 class="section-title text-center">
                                <?php esc_html_e('Related Projects', 'herocs'); ?>
                            </h2>
