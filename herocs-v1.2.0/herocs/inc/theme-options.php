...
function cs_customize_register($wp_customize) {
    ...
    $wp_customize->add_section('cs_colors_section', array(
        'title' => __('Theme Colors', 'cs-communication'),
        'priority' => 30,
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'cs_primary_color', array(
        'label' => __('Primary Color', 'cs-communication'),
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'cs_secondary_color', array(
        'label' => __('Secondary Color', 'cs-communication'),
        'section' => 'cs_colors_section',
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'cs_accent_color', array(
        'label' => __('Accent Color', 'cs-communication'),
        'section' => 'cs_colors_section',
    ...
    $wp_customize->add_section('cs_typography_section', array(
        'title' => __('Typography', 'cs-communication'),
        'priority' => 35,
    ));
    ...
    $wp_customize->add_control('cs_body_font', array(
        'label' => __('Body Font', 'cs-communication'),
    ...
    $wp_customize->add_control('cs_heading_font', array(
        'label' => __('Heading Font', 'cs-communication'),
        'section' => 'cs_typography_section',
        'type' => 'select',
        'choices' => array(
            'Poppins' => 'Poppins',
    ...
    $wp_customize->add_control('cs_font_size', array(
        'label' => __('Base Font Size (px)', 'cs-communication'),
        'section' => 'cs_typography_section',
        'type' => 'number',
        'input_attrs' => array(
            'min' => 14,
    ...
    $wp_customize->add_section('cs_layout_section', array(
        'title' => __('Layout Options', 'cs-communication'),
        'priority' => 40,
    ));
    ...
    $wp_customize->add_control('cs_container_width', array(
        'label' => __('Container Width (px)', 'cs-communication'),
    ...
    $wp_customize->add_control('cs_page_layout', array(
        'label' => __('Default Page Layout', 'cs-communication'),
        'section' => 'cs_layout_section',
        'type' => 'select',
        'choices' => array(
            'wide' => __('Wide', 'cs-communication'),
            'boxed' => __('Boxed', 'cs-communication'),
            'full-width' => __('Full Width', 'cs-communication'),
        ),
    ));
    ...
    $wp_customize->add_control('cs_sidebar_position', array(
        'label' => __('Sidebar Position', 'cs-communication'),
        'section' => 'cs_layout_section',
        'type' => 'select',
        'choices' => array(
            'left' => __('Left', 'cs-communication'),
            'right' => __('Right', 'cs-communication'),
            'none' => __('No Sidebar', 'cs-communication'),
        ),
    ));

    // ========== HEADER SECTION ==========
    $wp_customize->add_section('cs_header_section', array(
        'title' => __('Header Options', 'cs-communication'),
        'priority' => 45,
    ));
    ...
    $wp_customize->add_control('cs_sticky_header', array(
        'label' => __('Enable Sticky Header', 'cs-communication'),
    ...
    $wp_customize->add_control('cs_header_style', array(
        'label' => __('Header Style', 'cs-communication'),
        'section' => 'cs_header_section',
        'type' => 'select',
        'choices' => array(
            'default' => __('Default', 'cs-communication'),
            'transparent' => __('Transparent', 'cs-communication'),
            'minimal' => __('Minimal', 'cs-communication'),
        ),
    ));

    // ========== DARK MODE SECTION ==========
    $wp_customize->add_section('cs_dark_mode_section', array(
        'title' => __('Dark Mode', 'cs-communication'),
        'priority' => 50,
    ));
    ...
    $wp_customize->add_control('cs_enable_dark_mode', array(
        'label' => __('Enable Dark Mode Toggle', 'cs-communication'),
        'section' => 'cs_dark_mode_section',
        'type' => 'checkbox',
        'description' => __('Mostra il toggle dark mode nell\'header', 'cs-communication'),
    ));
   ...
   // Default Mode
    ...
    $wp_customize->add_control('cs_default_mode', array(
        'label' => __('Default Mode', 'cs-communication'),
        'section' => 'cs_dark_mode_section',
        'type' => 'select',
        'choices' => array(
            'light' => __('Light', 'cs-communication'),
            'dark' => __('Dark', 'cs-communication'),
            'auto' => __('Auto (System Preference)', 'cs-communication'),
        ),
    ));

    // ========== SOCIAL MEDIA SECTION ==========
    $wp_customize->add_section('cs_social_section', array(
        'title' => __('Social Media', 'cs-communication'),
        'priority' => 55,
    ));

    $social_networks = array(
        'facebook' => __('Facebook URL', 'cs-communication'),
        'twitter' => __('Twitter/X URL', 'cs-communication'),
        'linkedin' => __('LinkedIn URL', 'cs-communication'),
        'instagram' => __('Instagram URL', 'cs-communication'),
        'youtube' => __('YouTube URL', 'cs-communication'),
    );
...
// ========================================================================
    ...
    $wp_customize->add_section('cs_hero_slider_section', array(
        'title' => __('Hero Slider', 'cs-communication'),
        'priority' => 25,
        'description' => __('Configura lo slider della homepage. Puoi aggiungere fino a 5 slides con immagini o video caricati dalla Media Library o tramite URL esterno.', 'cs-communication'),
    ));
    ...
    $wp_customize->add_control('cs_hero_enable_slider', array(
        'label' => __('Enable Hero Slider', 'cs-communication'),
        'section' => 'cs_hero_slider_section',
        'type' => 'checkbox',
        'description' => __('Attiva lo slider automatico in homepage', 'cs-communication'),
    ));
    ...
    $wp_customize->add_control('cs_hero_slider_speed', array(
        'label' => __('Autoplay Speed (ms)', 'cs-communication'),
        'section' => 'cs_hero_slider_section',
        'type' => 'number',
        'input_attrs' => array(
            'min' => 3000,
        ...
        'description' => __('Tempo tra uno slide e l\'altro (3000-15000ms)', 'cs-communication'),
    ));
    ...
    $wp_customize->add_control('cs_hero_slider_effect', array(
        'label' => __('Effetto Transizione', 'cs-communication'),
        'section' => 'cs_hero_slider_section',
        'type' => 'select',
        'choices' => array(
            'fade' => 'Fade',
    ...
    // ========== OPZIONI VISIBILITÃ€ CONTENUTI SLIDER ==========
    ...
    $wp_customize->add_control('cs_hero_show_title', array(
        'label' => __('Mostra Titolo', 'cs-communication'),
        'section' => 'cs_hero_slider_section',
        'type' => 'checkbox',
        'description' => __('Mostra il titolo principale sopra le slide', 'cs-communication'),
    ));
    ...
    $wp_customize->add_control('cs_hero_show_subtitle', array(
        'label' => __('Mostra Sottotitolo', 'cs-communication'),
        'section' => 'cs_hero_slider_section',
        'type' => 'checkbox',
        'description' => __('Mostra il sottotitolo/descrizione sotto il titolo', 'cs-communication'),
    ));
    ...
    $wp_customize->add_control('cs_hero_show_button', array(
        'label' => __('Mostra Pulsante', 'cs-communication'),
        'section' => 'cs_hero_slider_section',
        'type' => 'checkbox',
        'description' => __('Mostra il pulsante call-to-action', 'cs-communication'),
    ));
    ...
    for ($i = 1; $i <= 5; $i++) {
        ...
        $wp_customize->add_control("cs_hero_slide_{$i}_enable", array(
            'label' => sprintf(__('Ã¢â€ÂÃ¢â€ÂÃ¢â€Â Slide %d Ã¢â€ÂÃ¢â€ÂÃ¢â€Â', 'cs-communication'), $i),
            'section' => 'cs_hero_slider_section',
            'type' => 'checkbox',
            'description' => sprintf(__('Abilita Slide %d', 'cs-communication'), $i),
        ));
        ...
        $wp_customize->add_control("cs_hero_slide_{$i}_type", array(
            'label' => __('Tipo Media', 'cs-communication'),
            'section' => 'cs_hero_slider_section',
            'type' => 'select',
            'choices' => array(
                'image' => __('Immagine', 'cs-communication'),
                'video' => __('Video', 'cs-communication'),
            ),
        ));
        ...
        $wp_customize->add_control(new WP_Customize_Media_Control($wp_customize, "cs_hero_slide_{$i}_image", array(
            'label' => __('Immagine da Media Library', 'cs-communication'),
            'section' => 'cs_hero_slider_section',
            'mime_type' => 'image',
            'description' => __('Seleziona un\'immagine dalla libreria (1920x1080 consigliato)', 'cs-communication'),
        )));
        ...
        $wp_customize->add_control("cs_hero_slide_{$i}_image_url", array(
            'label' => __('Oppure URL Immagine Esterna', 'cs-communication'),
            'section' => 'cs_hero_slider_section',
            'type' => 'url',
            'description' => __('URL diretto (.jpg, .png, .webp)', 'cs-communication'),
        ));
        ...
        $wp_customize->add_control(new WP_Customize_Media_Control($wp_customize, "cs_hero_slide_{$i}_video_media", array(
            'label' => __('Video da Media Library', 'cs-communication'),
            'section' => 'cs_hero_slider_section',
            'mime_type' => 'video',
            'description' => __('Carica un video MP4/WebM dalla libreria', 'cs-communication'),
        )));
        ...
        $wp_customize->add_control("cs_hero_slide_{$i}_video", array(
            'label' => __('Oppure URL Video Esterno', 'cs-communication'),
            'section' => 'cs_hero_slider_section',
            'type' => 'url',
            'description' => __('YouTube, Vimeo o URL diretto MP4', 'cs-communication'),
        ));
        ...
        $wp_customize->add_control("cs_hero_slide_{$i}_title", array(
            'label' => __('Titolo', 'cs-communication'),
            'section' => 'cs_hero_slider_section',
            'type' => 'text',
        ));
        ...
        $wp_customize->add_control("cs_hero_slide_{$i}_subtitle", array(
            'label' => __('Sottotitolo', 'cs-communication'),
            'section' => 'cs_hero_slider_section',
            'type' => 'textarea',
        ));
        ...
        $wp_customize->add_control("cs_hero_slide_{$i}_cta_text", array(
            'label' => __('Testo Pulsante', 'cs-communication'),
            'section' => 'cs_hero_slider_section',
            'type' => 'text',
        ));
        ...
        $wp_customize->add_control("cs_hero_slide_{$i}_cta_link", array(
            'label' => __('Link Pulsante', 'cs-communication'),
            'section' => 'cs_hero_slider_section',
            'type' => 'url',
        ));
        ...
        $wp_customize->add_control("cs_hero_slide_{$i}_overlay", array(
            'label' => __('OpacitÃƒÂ  Overlay (%)', 'cs-communication'),
            'section' => 'cs_hero_slider_section',
            'type' => 'range',
            'input_attrs' => array(
                'min' => 0,
    ...
    $wp_customize->add_section('cs_footer_section', array(
        'title' => __('Footer Options', 'cs-communication'),
        'priority' => 60,
    ));
    ...
    $wp_customize->add_control('cs_footer_description', array(
        'label' => __('Footer Description', 'cs-communication'),
        'section' => 'cs_footer_section',
        'type' => 'textarea',
        'description' => __('Breve descrizione mostrata nel footer', 'cs-communication'),
    ));

    // Copyright Text
    $wp_customize->add_setting('cs_copyright_text', array(
        'default' => sprintf(__('Ãƒâ€šÃ‚Â© %s. All rights reserved.', 'cs-communication'), date('Y')),
        'sanitize_callback' => 'wp_kses_post',
    ));
    $wp_customize->add_control('cs_copyright_text', array(
        'label' => __('Copyright Text', 'cs-communication'),
        'section' => 'cs_footer_section',
        'type' => 'textarea',
    ));
    ...
    $wp_customize->add_control('cs_footer_columns', array(
        'label' => __('Footer Columns', 'cs-communication'),
        'section' => 'cs_footer_section',
        'type' => 'select',
        'choices' => array(
            '1' => '1',
    ...
    $wp_customize->add_section('cs_performance_section', array(
        'title' => __('Performance', 'cs-communication'),
        'priority' => 65,
    ));
    ...
    $wp_customize->add_control('cs_preload_fonts', array(
        'label' => __('Preload Google Fonts', 'cs-communication'),
        'section' => 'cs_performance_section',
        'type' => 'checkbox',
        'description' => __('Improves font loading performance', 'cs-communication'),
    ));
    ...
    $wp_customize->add_control('cs_lazy_load', array(
        'label' => __('Enable Lazy Loading', 'cs-communication'),
        'section' => 'cs_performance_section',
        'type' => 'checkbox',
        'description' => __('Delays loading of images until they are in viewport', 'cs-communication'),
    ));

    // ========== BLOG SECTION ==========
    $wp_customize->add_section('cs_blog_section', array(
        'title' => __('Blog Options', 'cs-communication'),
        'priority' => 70,
    ));
    ...
    $wp_customize->add_control('cs_excerpt_length', array(
        'label' => __('Excerpt Length (words)', 'cs-communication'),
    ...
    $wp_customize->add_control('cs_show_author', array(
        'label' => __('Show Post Author', 'cs-communication'),
        'section' => 'cs_blog_section',
        'type' => 'checkbox',
    ));
    ...
    $wp_customize->add_control('cs_show_date', array(
        'label' => __('Show Post Date', 'cs-communication'),
        'section' => 'cs_blog_section',
        'type' => 'checkbox',
    ));
    ...
    $wp_customize->add_control('cs_show_categories', array(
        'label' => __('Show Post Categories', 'cs-communication'),
        'section' => 'cs_blog_section',
        'type' => 'checkbox',
    ));
}
