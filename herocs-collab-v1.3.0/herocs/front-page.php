...
<main id="primary" class="site-main homepage">
        ...
        <div class="intro-container">
            <div class="intro-grid">
                ...
                <div class="intro-content">
                    ...
                    <h2 class="section-title">Comunichiamo con passione, creiamo con strategià</h2>
    ...
    <section class="home-team">
        <div class="team-section-container">
            ...
            if ($team_query->have_posts()) :
                $team_count = $team_query->post_count;
            ?>
                <div class="team-slider-wrapper" data-slides="<?php echo esc_attr($team_count); ?>">
                    <!-- Loading State -->
                    <div class="slider-loading">
                        <div class="loading-spinner"></div>
                        <span>Caricamento team...</span>
                    </div>
                    ...
                    <div class="swiper team-swiper">
                        <div class="swiper-wrapper">
                            <?php while ($team_query->have_posts()) : $team_query->the_post(); 
                                ...
                                $skills = get_post_meta(get_the_ID(), '_cs_team_skills', true);
                            ?>
                                <div class="swiper-slide">
                                    <a href="<?php the_permalink(); ?>" class="team-slide-card" aria-label="<?php echo esc_attr(sprintf('Scopri il profilo di %s', get_the_title())); ?>">
                        ...
                        <!-- Navigation -->
                        <div class="team-nav-prev swiper-nav-btn" aria-label="Team member precedente">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="15 18 9 12 15 6"></polyline>
                            </svg>
                        </div>
                        <div class="team-nav-next swiper-nav-btn" aria-label="Team member successivo">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            ?>
                <div class="team-empty">
                    ...
                    <?php if (current_user_can('edit_posts')) : ?>
                        <a href="<?php echo admin_url('post-new.php?post_type=team'); ?>" class="empty-btn">+ Aggiungi membro</a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
    ...
    <!-- ========================================================================== -->
    <!-- 5. COLLABORAZIONI SLIDER (Swiper - Infinite Loop) -->
    <!-- ========================================================================== -->
    <section class="home-collaborazioni">
        <div class="collab-container">
            ...
            if ($collab_query->have_posts()) :
                $collab_count = $collab_query->post_count;
            ?>
                <div class="collab-slider-wrapper" data-slides="<?php echo esc_attr($collab_count); ?>">
                    <!-- Loading State -->
                    <div class="slider-loading">
                        <div class="loading-spinner"></div>
                        <span>Caricamento collaborazioni...</span>
                    </div>
                    ...
                    <div class="swiper collab-swiper">
                        <div class="swiper-wrapper">
                            <?php while ($collab_query->have_posts()) : $collab_query->the_post();
                                ...
                                $has_permalink = get_post_type() === 'collaborazioni';
                            ?>
                                <div class="swiper-slide">
                                    <?php if ($has_permalink) : ?>
                                    <a href="<?php the_permalink(); ?>" class="collab-logo-card collab-link" title="<?php echo esc_attr(sprintf('Scopri la collaborazione con %s', get_the_title())); ?>">
                                    <?php else : ?>
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <?php if ($logo) : ?>
                                            <img src="<?php echo esc_url($logo); ?>" 
                                                 alt="<?php echo esc_attr(sprintf('Logo %s', get_the_title())); ?>" 
                                                 class="collab-logo"
                                                 loading="lazy">
                                        <?php elseif (has_post_thumbnail()) : ?>
                                            <?php the_post_thumbnail('medium', array(
                                                'class' => 'collab-logo',
                                                'loading' => 'lazy',
                                                'alt' => esc_attr(sprintf('Logo %s', get_the_title()))
                                            )); ?>
                                        <?php else : ?>
                                        ...
                                        <?php if ($has_permalink) : ?>
                                        <div class="collab-hover-overlay">
                                            <span class="collab-hover-text">Scopri</span>
                                        </div>
                                        <?php endif; ?>
            ...
            ?>
                <div class="collab-empty">
                    ...
                    <?php if (current_user_can('edit_posts')) : ?>
                        <a href="<?php echo admin_url('post-new.php?post_type=collaborazioni'); ?>" class="empty-btn">+ Aggiungi collaborazione</a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
...
<!-- ========================================================================== -->
<!-- SWIPER INITIALIZATION - Inline backup (main.js has priority) -->
<!-- ========================================================================== -->
<script>
document.addEventListener('DOMContentLoaded', function() {
    
    // Skip if main.js already initialized (check for window objects)
    if (window.teamSwiper || window.collabSwiper) {
        console.log('Sliders already initialized by main.js');
        return;
    }
    
    // Team Slider
    const teamSwiperEl = document.querySelector('.team-swiper');
    if (teamSwiperEl && typeof Swiper !== 'undefined') {
        ...
        window.teamSwiper = new Swiper('.team-swiper', {
            ...
            on: {
                init: function() {
                    teamSwiperEl.closest('.team-slider-wrapper')?.classList.add('swiper-initialized');
                    console.log('Team Slider initialized:', slideCount, 'slides');
                },
            },
        });
    }
    
    // Collaborazioni Slider - Infinite Loop
    const collabSwiperEl = document.querySelector('.collab-swiper');
    if (collabSwiperEl && typeof Swiper !== 'undefined') {
        const slideCount = collabSwiperEl.querySelectorAll('.swiper-slide').length;
        
        window.collabSwiper = new Swiper('.collab-swiper', {
            slidesPerView: 2,
            spaceBetween: 20,
            loop: slideCount >= 4,
            ...
            on: {
                init: function() {
                    collabSwiperEl.closest('.collab-slider-wrapper')?.classList.add('swiper-initialized');
                    console.log('Collab Slider initialized:', slideCount, 'slides');
                },
            },
        });
    }
...
.team-slide-card:hover .overlay-text {
...
/* Dynamic bullets quando molte slide */
.team-pagination .swiper-pagination-bullets-dynamic {
    overflow: visible;
}

.team-pagination .swiper-pagination-bullet-active-main {
    background: linear-gradient(135deg, #7c3aed 0%, #ec4899 100%);
}

.team-pagination .swiper-pagination-bullet-active-prev,
.team-pagination .swiper-pagination-bullet-active-next {
    transform: scale(0.8);
    opacity: 0.7;
}

.team-pagination .swiper-pagination-bullet-active-prev-prev,
.team-pagination .swiper-pagination-bullet-active-next-next {
    transform: scale(0.6);
    opacity: 0.5;
}
...
.collab-link:hover .collab-hover-overlay {
    opacity: 1;
}
...
/* Show loading when swiper not initialized */
.team-slider-wrapper:not(.swiper-initialized) .slider-loading,
.collab-slider-wrapper:not(.swiper-initialized) .slider-loading {
    display: flex;
}

.team-slider-wrapper:not(.swiper-initialized) .team-swiper,
.collab-slider-wrapper:not(.swiper-initialized) .collab-swiper {
    opacity: 0;
}

.team-swiper.swiper-initialized,
.collab-swiper.swiper-initialized {
    opacity: 1;
    transition: opacity 0.3s;
}
...
@media (max-width: 1024px) {
    ...
    .team-nav-prev { left: 5px; }
    .team-nav-next { right: 5px; }
...
@media (max-width: 768px) {
    ...
    /* Frecce più piccole su mobile ma non nascoste */
    .swiper-nav-btn {
        width: 40px;
        height: 40px;
        opacity: 0.9;
...
@media (max-width: 480px) {
    /* Frecce ancora più piccole su telefoni piccoli */
    .swiper-nav-btn {
        width: 36px;
        height: 36px;
        opacity: 0.85;
...
body.dark-mode .team-pagination .swiper-pagination-bullet {
    background: #475569;
}

body.dark-mode .team-pagination .swiper-pagination-bullet:hover {
    background: #64748b;
}

body.dark-mode .team-pagination .swiper-pagination-bullet-active {
    background: linear-gradient(135deg, #a78bfa 0%, #f472b6 100%);
}
...
body.dark-mode .team-empty p,
body.dark-mode .collab-empty p {
    color: #94a3b8;
}

body.dark-mode .collab-scroll-hint {
    color: #64748b;
}

body.dark-mode .slider-loading {
    color: #64748b;
}

body.dark-mode .slider-loading .loading-spinner {
    border-color: #334155;
    border-top-color: #a78bfa;
}

body.dark-mode .collab-name {
    color: #94a3b8;
}
