    ...
    <div class="cs-container">
        <div class="error-404-content text-center">
            ...
            <header class="page-header cs-reveal">
                <h1 class="page-title"><?php esc_html_e('Oops! Page Not Found', 'herocs'); ?></h1>
                <p class="error-message">
                    <?php esc_html_e('The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.', 'herocs'); ?>
                </p>
            </header>

            <!-- Search Box -->
            <div class="error-404-search cs-reveal">
                <h2><?php esc_html_e('Try Searching', 'herocs'); ?></h2>
                <?php get_search_form(); ?>
            </div>

            <!-- Helpful Links -->
            <div class="error-404-links cs-reveal">
                <h3><?php esc_html_e('Or explore these sections:', 'herocs'); ?></h3>
                ...
                <div class="helpful-links-grid">
                    <a href="<?php echo esc_url(home_url('/')); ?>" class="helpful-link">
                        ...
                        <span><?php esc_html_e('Home Page', 'herocs'); ?></span>
                    </a>
                    ...
                    if ($portfolio_archive) :
                        ...
                        <a href="<?php echo esc_url($portfolio_archive); ?>" class="helpful-link">
                            ...
                            <span><?php esc_html_e('Portfolio', 'herocs'); ?></span>
                        </a>
                    <?php endif; ?>
                    ...
                    if ($blog_page) :
                        ...
                        <a href="<?php echo esc_url(get_permalink($blog_page)); ?>" class="helpful-link">
                            ...
                            <span><?php esc_html_e('Blog', 'herocs'); ?></span>
                        </a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            if ($recent_posts->have_posts()) :
                ...
                <div class="error-404-recent cs-reveal">
                    <h3><?php esc_html_e('Recent Blog Posts', 'herocs'); ?></h3>
            ...
            <div class="error-404-cta cs-reveal">
                <a href="<?php echo esc_url(home_url('/')); ?>" class="cs-btn cs-btn-primary cs-magnetic-btn">
                    <?php esc_html_e('Back to Homepage', 'herocs'); ?>
                </a>
            </div>
